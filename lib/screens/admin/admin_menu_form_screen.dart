...
class AdminMenuFormScreen extends StatefulWidget {
  final MenuModel? editing; // null = add new
...
class _State extends State<AdminMenuFormScreen> {
  ...
  Future<void> _save() async {
    ...
    if (_name.text.isEmpty || _price.text.isEmpty || _catId.isEmpty) {
      BrewSnackbar.show(context, 'Name, price & category are required!',
          isError: true);
      return;
    }
    ...
    if (_croppedBytes != null) {
      imageUrl = await StorageService.instance
          .uploadMenuImageFromBytes(_croppedBytes!);
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                DropdownButtonFormField<String?>(
                  ...
                  items: [
                    ...
                    ...MenuModel.labels.map((l) => DropdownMenuItem(
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    Text(_isAvailable ? 'Tersedia' : 'Sold Out',
                        style: AppTextStyles.bodySmall.copyWith(
                            color: _isAvailable
                                ? AppColors.successText : AppColors.error,
                            fontWeight: FontWeight.w700)),
                  ]),
                  Switch.adaptive(
                    value: _isAvailable,
  ...
  Widget _toggle(String label, bool val, ValueChanged<bool> onChange) =>
    Padding(padding: const EdgeInsets.only(bottom: 4),
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Switch.adaptive(value: val, onChanged: onChange,
            activeColor: Colors.white,
            activeTrackColor: AppColors.black,
